    ...
    <form action="/upload/store" method="post" enctype="multipart/form-data">
      ...
      <div class="max-w-screen-md mx-auto">
          <div class="flex flex-wrap items-center flex-container">
                ...
                <div class="mt-6">
                    <div class="flex flex-col px-9 gap-2">
                ...
                <!-- <div class="flex mt-2 "> -->
                    <!-- <div class="flex flex-col px-2"> -->
                            <div class="ml-4 w-[363px] h-[192px]">
                                <div class="mt-4 mb-2">
                                    <label for="default-input" class="mb-2 text-xl font-medium dark:text-dark">Judul</label>
                                ...
                                <div class="mb-2">                                  
                                    <div class="max-w-sm mx-auto">
                                      <label for="message" class="block text-xl font-medium text-gray-900 dark:text-dark">Deskripsi</label>
                                ...
                                <div class="w-[363px] h-[192px] ">
                                    <div class="mb-2">
                                        <h3 class="block text-xl font-medium">Album</h3>
                                    ...
                                    <Button type="text" id="default-input" class="rounded-md block p-1 border w-32 bg-blue-900 text-white ">Upload</Button>
                                </div>
                            </div>
                            </div>
                            </div>
