    ...
    <section class="mt-14">
        ...
        @endif
            ...
            <div class="flex flex-col">
                <h3 class="mx-auto text-4xl text-blue-900 font-fontutama">Login</h3>
                <h4 class="mt-3 font-medium">Email</h4>
                <input type="text" class="py-1 rounded-md w-full p-1 border text-slate-700" name="email">
                @error('email')
                ...
                <small class="italic text-red-800">{{ $message }}</small>
                @enderror
                <button type="submit" class="py-1 mt-4 text-center text-white rounded-full bg-blue-900">Login</a></button>
