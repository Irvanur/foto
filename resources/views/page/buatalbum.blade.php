...
<section class="mt-32">
        ...
        <div class="items-center max-w-screen-md mx-auto ">
            <h3 class="text-4xl text-center text-blue-900 font-fontutama">Buat Album</h3>
        </div>
    </section>
        ...
        <div class="max-w-screen-md mx-auto flex justify-center">
                <div class="w-2/5  max-[480px]:w-full px-2">
                    <div class="flex flex-col flex-wrap">
                        <h3 class="font-medium">Nama Album</h3>
                        <input type="text" name="nama_album" id="" class="py-1 rounded-lg border-slate-500">
                        <h3 class="mt-4 font-medium">Deskripsi</h3>
                        <textarea name="deskripsi" id="" cols="30" rows="10"
                            class="w-full h-24 mb-2 border-slate-500 rounded-lg"></textarea>
