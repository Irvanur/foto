...
<section class="mt-32">
        <div class="items-center max-w-screen-md mx-auto ">
            <h3 class="text-4xl text-center font-fontutama"></h3>
        </div>
</section>
            ...
            <div class="w-full">
                <div class="bg-white rounded-md shadow-md ">
                    <div class="flex flex-col px-8 py-4">
                        <h5 class="text-4xl text-center text-blue-900 font-fontutama my-5">Ubah Password</h5>
                        <h5 class="mt-7 font-medium">Password Lama</h5>
                        <input type="password" name="password_lama" class="py-1 rounded-md">
                        @error('password_lama')
                        <small class="italic text-red-800">{{ $message }}</small>
                        @enderror
                        <h5 class="mt-2 font-medium">Password Baru</h5>
                        <input type="password" name="password_baru" class="py-1 rounded-md">
                        @error('password_baru')
                        <small class="italic text-red-800">{{ $message }}</small>
                        @enderror

                        <h5 class="mt-2 font-medium">Konfirmasi Password</h5>
