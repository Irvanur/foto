...
<section class="max-w-screen-md mx-auto ">
    <div class="flex flex-wrap justify-between mt-10 flex-container">
        ...
        <div class="w-3/5 max-[480px]:w-full">
            <div class="bg-white rounded-md shadow-md ">
                <div class="flex flex-col px-4 py-4 ">
                    <h4 class="text-3xl text-center text-blue-900 font-fontutama">Profil Anda</h4>
        ...
        @endif
            <h5 class="mt-3 font-medium">Username</h5>
            <input type="text" name="nama_lengkap" value="{{$user->nama_lengkap}}" class="py-1 border rounded-lg">
            <h5 class="mt-3 font-medium">Alamat</h5>
            <input type="text" name="alamat" value="{{$user->alamat}}" class="py-1 border rounded-lg">
            <button type="submit" class="py-2 mt-4 text-white rounded-lg bg-blue-900">Perbaharui</button>
            </div>
            </div>
        </div>
    </div>
